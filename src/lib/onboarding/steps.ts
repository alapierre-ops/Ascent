...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  {
    id: 'achievements-back',
    type: 'spotlight',
    target: 'achievements-back',
    titleKey: 'achievementsBack.title',
    bodyKey: 'achievementsBack.body',
  ...
  },
  {
    id: 'overdue-mission',
    type: 'spotlight',
    target: 'overdue-mission',
    titleKey: 'overdueMission.title',
    bodyKey: 'overdueMission.body',
    ctaKey: 'next',
    advanceOn: 'next',
    route: 'dashboard',
  },
  ...
  {
    id: 'choose-theme-modal',
    type: 'spotlight',
    target: 'theme-picker',
    titleKey: 'chooseThemeModal.title',
    bodyKey: 'chooseThemeModal.body',
    ctaKey: 'next',
    advanceOn: 'next',
    route: 'dashboard',
  },
