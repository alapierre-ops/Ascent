...
- Name: features\i18n.spec.ts >> Feature: Internationalisation (i18n) >> French locale (/fr) >> registration with locale=fr returns success
- Location: tests\features\i18n.spec.ts:84:9
