...
- Name: features\auth-login.spec.ts >> Feature: Login / Sign-up UI >> Sign In >> redirects to dashboard on successful login
- Location: tests\features\auth-login.spec.ts:63:9
                        ...
                        - generic [ref=e54]:
                            - generic [ref=e55]:
                                ...
                                - textbox "Email" [ref=e57]:
                                    ...
                                    - text: login+1781562363895@example.com
                            - generic [ref=e58]:
                                - generic [ref=e59]:
