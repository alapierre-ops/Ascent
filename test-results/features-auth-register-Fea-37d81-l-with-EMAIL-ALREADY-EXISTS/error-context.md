...
- Name: features\auth-register.spec.ts >> Feature: User Registration >> rejects a duplicate email with EMAIL_ALREADY_EXISTS
- Location: tests\features\auth-register.spec.ts:25:7
