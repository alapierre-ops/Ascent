...
- Name: features\protected-routes.spec.ts >> Feature: Protected Routes >> Authenticated access >> authenticated user visiting the auth page is redirected to dashboard
- Location: tests\features\protected-routes.spec.ts:97:9
                        ...
                        - generic [ref=e54]:
                            - generic [ref=e55]:
                                ...
                                - textbox "Email" [ref=e57]:
                                    ...
                                    - text: prot-auth+1781562462117@example.com
                            - generic [ref=e58]:
                                - generic [ref=e59]:
